...
asociada a nuestra cuentas y repositorio de Github. Para visualizarlos acceder al siguiente enlace:

---adjuntar enlace---

Para ejectutar esta práctica usaremos el comando $rake
